    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-6 space-y-8">
        ...
        <nav className="space-y-4">
          <Link href="/decks" className="flex items-center space-x-3 text-gray-700 hover:text-gray-900">
          ...
          <Link href="/statistics" className="flex items-center space-x-3 text-gray-700 hover:text-gray-900">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M4 14L8 10L12 14L20 6"/>
            </svg>
            <span>Statistics</span>
          </Link>
          <Link href="/history" className="flex items-center space-x-3 text-gray-700 hover:text-gray-900">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/settings" className="flex items-center space-x-3 text-gray-700 hover:text-gray-900">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800 flex items-center space-x-2">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {decks.map((deck) => (
              ...
              >
                ...
                <p className="text-gray-600 mb-4">{deck.total_cards} cards</p>
                {deck.due_cards > 0 && (
                  <div className="mb-4">
                    <div className="h-2 bg-gray-200 rounded-full">
                      <div 
                        className="h-2 bg-green-500 rounded-full"
                        style={{ width: `${(deck.due_cards / deck.total_cards) * 100}%` }}
                      />
                    </div>
                    <p className="text-sm text-gray-600 mt-2">Due today: {deck.due_cards} cards</p>
                  </div>
                )}
            ...
            <div className="bg-white p-6 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-500 hover:border-green-500 hover:text-green-500 cursor-pointer">
              ...
              <p className="text-sm">Add a new collection of flashcards</p>
            </div>
          </div>
        )}
